...
## Project Structure
    ...
    ├── testapiautoteammem_109695  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_109695`
...
2. Clone this repo and `cd testapiautoteammem_109695`
